...
When this resource is done it will run at a sligher higher resmon ms than most scripts but it utilizing this properly will bring total resmon ms in a server down
